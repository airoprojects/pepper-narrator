...
tmux send-keys -t $SESSION:4 "cd ~/playground/pepper-narrator/pepper ; python main.py" C-m
tmux split-window -t $SESSION:4
tmux send-keys -t $SESSION:4 "cd ~/playground/pepper-narrator/pepper ; python bridge.py" C-m
